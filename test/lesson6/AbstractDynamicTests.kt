...
abstract class AbstractDynamicTests {
    fun longestCommonSubSequence(longestCommonSubSequence: (String, String) -> String) {
        ...
        assertEquals("кот", longestCommonSubSequence("кот", "кот кот кот"))
...
Наследник всех своих родных.
    ...
    fun shortestPathOnField(shortestPathOnField: (String) -> Int) {
        ...
        assertEquals(35, shortestPathOnField("input/field_in4.txt"))
        assertEquals(30, shortestPathOnField("input/field_in5.txt"))
        assertEquals(27, shortestPathOnField("input/field_in6.txt"))
    }
